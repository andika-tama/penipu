        ...
        { 
            foreach ($laporan as $nr) :?>
             <tr>
               ...
               <td width="20px" onclick= "javascript: return confirm('Anda yakin menghapus laporan?')"><?php echo anchor('admin/laporan_masuk/hapus_laporan/'.$nr->id_laporan, '<div class="btn btn-sm btn-danger" label="Hapus"><i class="fa fa-trash"></i></div>') ?></td>
           </tr>
       <?php endforeach;  
        }
        else
